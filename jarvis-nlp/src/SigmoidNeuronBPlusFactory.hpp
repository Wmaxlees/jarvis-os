...
/**
	FILE: SigmoidNeuronBPlusFactory.hpp

	@author W. Max Lees
	@docdate 06.06.2015

	@descr Header for class that generates B+ Sigmoid Neurons
*/

#ifndef _H_SIGMOIDNEURONBPLUSFACTORY
#define _H_SIGMOIDNEURONBPLUSFACTORY
...
#endif // _H_SIGMOIDNEURONBPLUSFACTORY
